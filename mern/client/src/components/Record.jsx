...
export default function Record() {
  ...
  async function onSubmit(e) {
    ...
    try {
      let response;
      if (isNew) {
        // if it's new we have to create new record with POST
        ...
        // otherwise we are updating existing with PATCH
  ...
  // return the form that gets user input
  return (
    <>
...
rounded-md px-3 cursor-pointer mt-4"
        />
      </form>
    </>
  );
